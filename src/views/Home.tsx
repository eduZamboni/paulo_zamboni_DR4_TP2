...
const Home: React.FC = () => {
  ...
  const [sleepGoal] = useState<number>(12); // Meta diária de sono
  const [diaperGoal] = useState<number>(10); // Meta diária de fraldas
    ...
    <main className="App">
      <Container className="header">
        ...
        <div>
          ...
          >
            <Avatar name="Paulo Zamboni" size={40} />
          </IconButton>
        </div>
      </Container>
